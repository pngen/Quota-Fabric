...
int main() {
  ...
  auto r = ef.reserve(t, V(4096), a);
  ef.set_tenant_quota(t, QV(t, 1024, 1024, 1024));
  std::printf("after lowering hard to 1024 with 4096 reserved: compliance=%s\n", to_string(ef.compliance_after_lowering(t)).data());
  return 0; }